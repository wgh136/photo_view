...
class _PhotoViewImageState extends State<PhotoViewImage> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    _scrollAwareContext = DisposableBuildContext<State<PhotoViewImage>>(this);
  }
